...
export const MenuIcon = (props: IconProps) => <Svg {...props}><path d="M4 7h16M4 12h10M4 17h16" /></Svg>
export const SearchIcon = (props: IconProps) => <Svg {...props}><circle cx="11" cy="11" r="7" /><path d="M20 20l-4-4" /></Svg>
